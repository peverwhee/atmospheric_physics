...
!--- input arguments:
 ...
 real(kind=kind_phys),intent(in),dimension(:):: rn
 real(kind=kind_phys),intent(in),dimension(:,:):: exner,qv,qc,qi,t,u,v,qvf,qcf,qif,tf,uf,vf


!--- output arguments:
 real(kind=kind_phys),intent(out),dimension(:):: raincv,pratec
 real(kind=kind_phys),intent(out),dimension(:,:):: rqvcuten,rqccuten,rqicuten
 real(kind=kind_phys),intent(out),dimension(:,:):: rthcuten,rucuten,rvcuten
