module cam_diagnostics
   ...
   character(len=65) :: const_std_names(5) = &
   ...
   character(len=6) :: const_diag_names(5) = (/'Q     ', &
                                               'CLDLIQ', &
                                               'RAINQM', &
                                               'CLDICE', &
                                               'SNOWQM'/)
...
CONTAINS
   ...
   subroutine cam_state_diagnostics_init(const_props, errmsg, errflg)
      ...
      call history_add_field('cnst_NUMLIQ', 'cnst_NUMLIQ', 'lev', 'avg', 'kg kg-1', mixing_ratio='wet')
...
!      call const_get_index('cnst_NUMLIQ', const_idx, abort=.false., warning=.false.)
      call history_out_field('cnst_NUMLIQ', const_array(:,:,18))
