...
public :: initialize_dynamic_constituents_from_file
public :: initialize_constituents_run

contains

subroutine initialize_dynamic_constituents_from_file(constituents, errmsg, errcode)
    ...
    character(len=65), parameter :: const_std_names(5) = &
    ...
    character(len=11), parameter :: const_file_names(5) = (/'cnst_Q     ', &
                                                 'cnst_CLDLIQ', &
                                                 'cnst_RAINQM', &
                                                 'cnst_CLDICE', &
                                                 'cnst_SNOWQM'/)
  ...
  end subroutine initialize_dynamic_constituents_from_file
